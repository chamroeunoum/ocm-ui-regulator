<template>
  <div class="font-pvh flex w-full h-16 p-2 border-b border-gray-300 " >
    ...
    <div v-if="profilePicture!=null" class="flex-none h-12 leading-10 pt-1 font-muol text-right mr-4 invisible sm:visible md:visible lg:visible xl:visible">{{ username }}</div>
    <div class="flex-none ">
      <!-- User profile -->
      <div v-if="isLoggedIn" class="relative "  >
        <div class="w-12 h-12 rounded-full overflow-hidden bg-red-500" @click="subMenuHelper=!subMenuHelper" >
