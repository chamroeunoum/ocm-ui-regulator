<template>
  <div class="font-pvh flex w-full h-10 p-1 border-b" >
    <div class="flex-none w-6 rounded-xl mr-1" >
      ...
      <div v-if="isLoggedIn" class="relative "  >
        ...
        <Transition name="fade" >
          ...
          ">
            ...
            <router-link to="/profile" class="myProfile m-4 p-4 cursor-pointer" >
              <div class="submenu-icon h-24 flex flex-wrap justify-center text-center">
                <svg class="flex-none mx-auto p-4 w-24 text-blue-500 " xmlns="http://www.w3.org/2000/svg"  fill="none" viewBox="0 0 24 24" stroke="#0066FF">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <div class="submenu-icon-title h-8 w-full leading-9 font-bold" >ព៌ត័មានខ្ញុំ</div>
              </div>
            </router-link>
            <router-link to="/password/change"  class="changePassword m-4 p-4 cursor-pointer" >
              <div class="submenu-icon h-24 flex flex-wrap justify-center text-center">
            ...
            <div class="logout w-32 h-32 m-2 p-4 rounded-xl border border-gray-200 text-center cursor-pointer hover:border-gray-300 hover:shadow duration-300 " @click="logout()" >
            ...
            <div class="fixed w-12 h-12 bottom-5" >
              ...
              class=" border-gray-200 duration-300 rounded-xl h-12 text-red-500 p-1 mx-auto cursor-pointer" 
